...
public interface IFunctionService {
	...
	public void modify(FunctionModel function) throws Exception;
	...
	//取得指定模块系统功能列表
	//参数：moduleNo → 模块编号
	public List<FunctionModel> selectListByModule(int module) throws Exception;
	
	//取得指定的系统功能对象
	public FunctionModel selectListByNo(int no) throws Exception;
