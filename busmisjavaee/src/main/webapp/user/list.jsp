            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>${um.joinDate }</td>
                  <td>${um.statusName}</td>
                  <td><a href="tomodify.do?id=${um.id }" class="btn btn-info">修改</a> <a href="todelete.do?id=${um.id }" class="btn btn-info">删除</a> <a href="todetail.do?id=${um.id }" class="btn btn-info">详细</a> 
